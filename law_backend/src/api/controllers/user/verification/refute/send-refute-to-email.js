...
export default async function sendRefuteToEmail({
  email,
  subject,
  reasons,
}) {
  ...
  sendSmtpEmail.htmlContent = RefuteBody({ reasons: reasons })
...
function RefuteBody({reasons}) {
  ...
  <body>
      <div class="container">
          ...
          <p>Your approval for account verfication is rejected!</p>
          <div class="verfied-image-outer">
              <img src="https://cdn-icons-png.flaticon.com/512/8072/8072913.png" width="80" height="80" />
          </div>
          <hr/>
          <h4>Why your request is Rejected?<br/>Reasons :</h4>
          <pre class="reasons">${reasons}</pre>
          <hr/>
